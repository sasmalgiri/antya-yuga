...
extension TowerKind {
    ...
    var sanskritTitle: String {
        ...
        case .narayanaAstra:     return "नारायणास्त्र"
        case .pashupatastra:     return "पाशुपतास्त्र"
        case .mayaAstra:         return "माया अस्त्र"
        case .gangaAstra:        return "गंगा अस्त्र"
        case .anjalikaAstra:     return "अंजलिक अस्त्र"
        case .brahmasiraAstra:   return "ब्रह्मशिर अस्त्र"
        case .bala:              return "बल"
    ...
    var subtitle: String {
        ...
        case .shaktiAstra:       return "Karna's Piercing Spear"
        ...
        case .mayaAstra:         return "Illusion of the Phantom Bow"
        case .gangaAstra:        return "Flow of the Sacred River"
        case .anjalikaAstra:     return "Arjuna's Piercing Arrow"
    ...
    var bestowedBy: String {
        ...
        case .narayanaAstra:                        return "Vishnu"
        case .mayaAstra, .gangaAstra, .anjalikaAstra, .brahmasiraAstra:
            return "Maya / Ganga / Arjuna / Brahma"
    ...
    var loreDescription: String {
        ...
        case .shaktiAstra:       return "Karna's gifted spear from Indra — pierces through multiple foes in a single flight."
        ...
        case .rudraAstra:        return "Rudra's wrath in flame form. Scorches the earth with relentless burning fury."
        ...
        case .narayanaAstra:     return "Vishnu's storm of a thousand arrows. Releases a tempest of divine missiles that strike all foes in their path."
        case .pashupatastra:     return "Shiva's ultimate weapon — wielded by Krishna in the Mahabharata. The most powerful astra known."
        case .mayaAstra:         return "Crafted by Maya the asura architect. Phantom arrows that confuse and pierce illusion-clad foes."
        case .gangaAstra:        return "The sacred river weapon. Cleanses and flows through enemy ranks, drowning multiple foes in divine waters."
        case .anjalikaAstra:     return "Arjuna's signature piercer — gifted by Indra. A relentless arrow that bypasses normal defences."
        case .brahmasiraAstra:   return "Brahma's three-headed astra. A near-apex divine weapon that splits into multiple strikes on release."
    ...
    var chant: String {
        ...
        case .narayanaAstra:     return "ॐ नारायणाय नमः"
        case .pashupatastra:     return "ॐ पशुपतये नमः"
        case .mayaAstra:         return "ॐ मायायै नमः"
        case .gangaAstra:        return "ॐ गंगायै नमः"
        case .anjalikaAstra:     return "ॐ अंजलिकाय नमः"
        case .brahmasiraAstra:   return "ॐ ब्रह्मशिराय नमः"
